...
function renderRecipes() {
  const recipe = hotRecipes[currentIndex];
...
// Call the fetchHotRecipes when the DOM is loaded
document.addEventListener("DOMContentLoaded", fetchHotRecipes);
